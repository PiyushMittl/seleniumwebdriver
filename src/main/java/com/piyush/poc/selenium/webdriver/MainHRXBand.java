...
public class MainHRXBand {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.currentThread().sleep(2000);
		driver.get("http://www.mi.com/in/mi-band-hrx/");
		...
		//driver.get("http://buy.mi.com/in/cart/recommend?phone=mi-band-hrx&goodsId=4173200001");
		...
		jse.executeScript("window.scrollBy(250,250)", "");
		Thread.currentThread().sleep(2000);
		driver.findElement(By.xpath("//*[@id=\"checkoutFormBtn\"]")).click();
